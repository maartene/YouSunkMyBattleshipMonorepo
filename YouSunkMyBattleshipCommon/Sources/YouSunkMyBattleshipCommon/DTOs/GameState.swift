public struct GameState: Codable, Sendable {
    ...
    public init(cells: [Player: [[String]]] = [:], shipsToDestroy: Int = 5, state: State = .placingShips, lastMessage: String = "Play!", currentPlayer: Player, shipsToPlace: [String] = [], gameID: String = "") {
        self.cells = cells
